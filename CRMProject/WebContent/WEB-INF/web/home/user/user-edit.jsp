...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-md-8 col-xs-12">
			<div class="white-box">
				<form action='<c:url value="/user/update"/>' enctype="multipart/form-data" 
					method="post" class="form-horizontal form-material">

					<div class="form-group">
						<label class="col-md-12">Id</label>
						<div class="col-md-12">
							<input type="text" name="txtId" value="${ user.id }"
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<input type="email" name="txtEmail" value="${ user.email }"
								class="form-control form-control-line" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<input type="text" name="txtName" value="${ user.fullname }"
								class="form-control form-control-line" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<input type="file" name="txtAvatar" value="${ user.avatar }"
								class="form-control form-control-line" />
						</div>
					</div>
